...
const Ideal = ({ cropName, soilConditions }) => {
  ...
  const getSoilAdjustmentSuggestion = async () => {
    const instruction = (languageName === "Default" || languageName === "English") ? '' : ` Give instructions in strict ${languageName} Language with no other words than the ${languageName} words.`;
